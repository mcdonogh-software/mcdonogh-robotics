...
public class OI {
    ...
    public OI() {
        ...
        leftBumper = new JoystickButton(controllerOne, 5);
        leftBumper.whenPressed(new ShiftDown());
        rightBumper = new JoystickButton(controllerOne, 6);
    ...
    public double getSecondX(){
        return controllerOne.getRawAxis(4);
    }
    
    public double getSecondY(){
        return controllerOne.getRawAxis(5);
    }
